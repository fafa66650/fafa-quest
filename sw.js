const CACHE='fafa-quest-v0.1.0';
const ASSETS=['./','./index.html','./styles.css','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./js/app.js','./js/data.js','./js/storage.js','./js/session.js','./js/engine.js','./js/ui.js','./js/accessibility.js'];
